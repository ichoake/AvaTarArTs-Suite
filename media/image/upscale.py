...
class for global variables."""
    ...
    upscaled_image.save(output_path, dpi = (DPI_300, DPI_DPI_300))  # Set resolution to DPI_300 DPI
...
# Function to upscale an image by 2x and set resolution to DPI_300 DPI
async def upscale_image(input_path, output_path):
def upscale_image(input_path, output_path): -> Any
try:
...
logger.error(f"Error in function: {e}")
    raise
"""
Upscale an image by 2x and set resolution to DPI_300 DPI.
...
logger.info("Images upscaled by 2x and set to DPI_300 DPI successfully.")
