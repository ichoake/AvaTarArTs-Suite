...
logger.info("Current script's schedule:")
logger.info("Going to follow followers of:", follow_followers_list)
logger.info("Going to follow following of:", follow_following_list)
logger.info("Going to like hashtags:", like_hashtags_list)
logger.info("Going to like users:", like_users_list)
