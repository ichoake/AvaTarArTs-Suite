...
class for global variables."""
    ...
    process = Popen(command, shell
    root = tk.Tk()
    command_label = tk.Label(root, text
    command_entry = tk.Entry(root, width
    execute_button = tk.Button(root, text
    output_text = scrolledtext.ScrolledText(root, wrap
