...
class for global variables."""
    ...
    async def get_total_hashtag_medias(self, hashtag, amount = DEFAULT_BATCH_SIZE, filtration
...
def get_total_hashtag_medias(self, hashtag, amount = DEFAULT_BATCH_SIZE, filtration = False): -> Any
