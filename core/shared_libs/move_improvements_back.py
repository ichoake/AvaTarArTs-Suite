...
def main():
    """Main function."""
    if len(sys.argv) != 3:
        print("Usage: python move_improvements_back.py <python_directory> <copied_files_directory>")
        sys.exit(1)
    ...
    print("\n" + "="*60)
    print("IMPROVEMENTS MOVED BACK SUCCESSFULLY")
    print("="*60)
    print("All improved files have been moved back to the original directory.")
    print("Check the MOVE_SUMMARY.md file for details on the new organization.")
    print("="*60)
