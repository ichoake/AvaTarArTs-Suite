...
{{
    ...
    "tags": ["tag1", "tag2", "tag3"]
        ...
        try:
            ...
            print(f"{Colors.YELLOW}{Emojis.WARN} AI analysis error: {e}{Colors.END}")
    ...
    def _query_openai(self, prompt: str) -> Dict:
        ...
        try:
            ...
            print(f"{Colors.RED}OpenAI error: {e}{Colors.END}")
            return self._fallback_analysis()
    ...
    def _query_gemini(self, prompt: str) -> Dict:
        ...
        try:
            ...
            print(f"{Colors.RED}Gemini error: {e}{Colors.END}")
    ...
    def _query_anthropic(self, prompt: str) -> Dict:
        ...
        try:
            ...
            print(f"{Colors.RED}Anthropic error: {e}{Colors.END}")
    ...
    def get_embedding(self, code: str, identifier: str) -> Optional[List[float]]:
        ...
        try:
            ...
            response = openai.embeddings.create(
                model="text-embedding-3-small", input=code[:2000]
            )
...
class AIDeepIntelligentAnalyzer:
    ...
    def run(self):
        ...
        print(f"  Files: {Colors.CYAN}{self.stats['total_files']:,}{Colors.END}")
...
def main():
    """Main execution"""
    # Load environment
    env_file = "/Users/steven/.env.d/MASTER_CONSOLIDATED.env"
    if Path(env_file).exists():
        print(f"{Colors.CYAN}Loading API keys...{Colors.END}")
