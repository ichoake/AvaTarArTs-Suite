...
async def upload_image(api_key, image_file_path):
def upload_image(api_key, image_file_path): -> Any
 """
...
async def upscale_image(api_key, image_id):
def upscale_image(api_key, image_id): -> Any
 """
 TODO: Add function documentation
 """
 try:
...
async def get_upscaled_image(api_key, variation_id):
def get_upscaled_image(api_key, variation_id): -> Any
 """
 TODO: Add function documentation
 """
 try:
