...
class for global variables."""
    ...
    audio_file = input("Enter the path to the MP3 file (e.g., your_music.mpMAX_RETRIES): ")
...
async def convert_to_mp4(image, audio, output):
def convert_to_mp4(image, audio, output): -> Any
 """
...
logger.info("Conversion Complete. The MP4 file is ready for upload to YouTube.")
