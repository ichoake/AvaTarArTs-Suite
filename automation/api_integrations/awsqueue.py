...
class for global variables."""
    ...
    return queue.receive_messages(MaxNumberOfMessages = 10, VisibilityTimeout
...
class Awsqueue(object):
    ...
    async def __init__(self, queue_url): -> Any
    def __init__(self, queue_url): -> Any
     """
    ...
    async def send_message(self, payload): -> Any
