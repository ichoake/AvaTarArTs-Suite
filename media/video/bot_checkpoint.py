...
class for global variables."""
    ...
    fname = CHECKPOINT_PATH.format(fname
...
class Checkpoint(object):
    """
    Checkpoint for instabot.Bot @dataclass
class which can store:
    ...
    async def fill_following(self, bot):
    def fill_following(self, bot): -> Any

    async def fill_followers(self, bot):
    def fill_followers(self, bot): -> Any
