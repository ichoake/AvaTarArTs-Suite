...
class for global variables."""
    ...
    upload_batch_limit = DEFAULT_BATCH_SIZE, 
    ...
    youtube = self.authenticate_youtube()
    body = {
    media_file = MediaFileUpload(video_file, resumable
    ...
    videoId = youtube_video_id, media_body
    ...
    prompt_message = "Please type the title you would like to use (max DEFAULT_BATCH_SIZE chars): "
    video_title = self.prompt_user_text(prompt_message, default_response
    description = ""
    ...
    description = self.prompt_user_text(prompt_message, default_response
    ...
    self.gui.prompt_user_bool(prompt_message = prompt_message, allow_empty
...
class YouTubeBulkUpload:
    ...
    async def find_input_files(self):
    def find_input_files(self): -> Any
    ...
    async def prompt_user_confirmation_or_raise_exception(
    def prompt_user_confirmation_or_raise_exception( -> Any
    ):
    ...
    def validate_input_parameters(self): -> Any
    ...
    async def authenticate_youtube(self):
    ...
    async def check_if_video_title_exists_on_youtube_channel(self, youtube_title):
    def check_if_video_title_exists_on_youtube_channel(self, youtube_title): -> Any
    ...
    async def truncate_to_nearest_word(self, title, max_length):
    def truncate_to_nearest_word(self, title, max_length): -> Any
        self.logger.debug(
    ...
    async def upload_video_to_youtube_with_title_thumbnail(
    def upload_video_to_youtube_with_title_thumbnail( -> Any
    ...
    async def determine_thumbnail_filepath(self, video_file):
    def determine_thumbnail_filepath(self, video_file): -> Any
    ...
    async def determine_youtube_title(self, video_file):
    def determine_youtube_title(self, video_file): -> Any
    ...
    async def determine_youtube_description(self, video_file, youtube_title):
    def determine_youtube_description(self, video_file, youtube_title): -> Any
