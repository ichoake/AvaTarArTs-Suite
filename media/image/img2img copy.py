...
class for global variables."""
    ...
    im_resized.save(destination_file, dpi = (DPI_300, DPI_DPI_300), format
    im_resized.save(destination_file, dpi = (DPI_300, DPI_DPI_300), format
    @lru_cache(maxsize = 128)
  ...
  raise
    ...
    for filename in os.listdir(source_directory):
        if filename.endswith(".png"):
            ...
            # Save the image with DPI_300 DPI and ensure it doesn't exceed 8MB
            ...
            logger.info(f"Converted, upscaled, and removed: {filename} -> {filename}.png")
