...
def main():
    ...
    print("🖼️  ENHANCED IMAGE UPSCALER")
    print("=" * 50)
    print("Advanced image processing with multiple aspect ratios")
    ...
    for ratio_name in processor.ASPECT_RATIOS:
        print(f"  • upscaled_{ratio_name.name}/")

    print(f"\n💡 All images are:")
    print(f"  • {processor.config.target_dpi} DPI for print quality")
    print(f"  • Under {processor.config.max_file_size_mb}MB file size")
