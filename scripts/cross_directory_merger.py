...
Features:
✨ Cross-directory duplicate detection (by SHA-256 hash)
...
class CrossDirectoryMerger:
    ...
    def run(self):
        ...
        print("╔═══════════════════════════════════════════════════════════════════════════════╗")
        print("║                                                                               ║")
        print("║          🔄 CROSS-DIRECTORY INTELLIGENT MERGER 🧠                            ║")
        print("║                                                                               ║")
        print("║    Merge Multiple Directories with Duplicate Detection                       ║")
        print("║                                                                               ║")
        print("╚═══════════════════════════════════════════════════════════════════════════════╝")
        print(f"{Colors.END}\n")
        ...
        print(f"  To merge: {Colors.CYAN}{self.stats['files_to_merge']:,}{Colors.END}")
        print(f"  Duplicates found: {Colors.YELLOW}{self.stats['duplicates_found']:,}{Colors.END}")
        print(f"  Skipped (already in master): {Colors.YELLOW}{self.stats['files_skipped']:,}{Colors.END}\n")
