...
async def compile_image_info(root_directory, master_csv_file_path):
def compile_image_info(root_directory, master_csv_file_path): -> Any
 """
...
compile_image_info("~/csv2", "~/master_image_info.csv")
