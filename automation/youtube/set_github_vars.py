...
class for global variables."""
    ...
    result = subprocess.run(["youtube-bulk-upload", "--version"], capture_output
...
async def get_cpu_architecture():
def get_cpu_architecture(): -> Any
 """
 TODO: Add function documentation
 """
 try:
...
async def extract_app_version():
def extract_app_version(): -> Any
 """
 TODO: Add function documentation
 """
 try:
...
async def write_to_github_env(vars_key_values_dict):
def write_to_github_env(vars_key_values_dict): -> Any
 """
 TODO: Add function documentation
 """
 try:
  ...
  logger.error(f"Error in function: {e}")
  raise
    logger.info(f"Writing values to GITHUB_ENV file {github_env_filepath}:")
