...
# MAX_RETRIES. Authentication Function:
...
if __name__ == "__main__":
    ...
    # VIDEO_CATEGORY_ID: YouTube category for the video (22 = People & Blogs).
        "22"  # See https://developers.google.com/youtube/v3/docs/videoCategories/list
    )

    # VIDEO_KEYWORDS: List of tags for the video.

    # VIDEO_PRIVACY_STATUS: Privacy setting for the video.
