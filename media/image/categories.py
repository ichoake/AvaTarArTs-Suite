...
class for global variables."""
    ...
    file_size = os.path.getsize(file_path) / (KB_SIZE * KB_SIZE)  # Convert to MB
    category = "Other"
    category = cat
    ...
    @lru_cache(maxsize = 128)
    async def export_to_csv(data, output_file = "categorized_files.csv"):
    @lru_cache(maxsize = 128)
...
def export_to_csv(data, output_file="categorized_files.csv"): -> Any
 """
 TODO: Add function documentation
 """
 try:
