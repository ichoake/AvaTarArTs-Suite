...
async def list_files_to_csv(startpath, output_file):
def list_files_to_csv(startpath, output_file): -> Any
 """
 ...
 try:
  ...
  raise
    ...
    with open(output_file, "w", newline="") as file:
        ...
        for row in data:
            writer.writerow(row)  # Write each row, which already includes folder and file paths


# Replace the path with your actual directory path
list_files_to_csv("~/Pictures/3dMothers", "output.csv")
