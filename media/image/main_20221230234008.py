...
class for global variables."""
    ...
    size = (intro_width + DEFAULT_BATCH_SIZE, intro_height + 50), color
    intro_clip = VideoFileClip("intro_clip/2_hands_up.mp4").resize((DEFAULT_HEIGHT, DEFAULT_WIDTH))
...
def scrapeVideos(pexelsApiKey: str): -> Any
    ...
    try:
        ...
        return None
    if results == 0:
        logger.info("No video results for your query: ", parameters["query"], "\\\nExiting...")
        return None
    return data
...
def videoIntro(introText, videoNumber) -> CompositeVideoClip:
        ...
        .set_position(lambda t: ("center", 200 + t))
