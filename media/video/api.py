...
class for global variables."""
    ...
    return requests.get("https://api.twitch.tv/" + endpoint, headers = headers, params
    @lru_cache(maxsize = 128)
    @lru_cache(maxsize = 128)
    @lru_cache(maxsize = 128)
    @lru_cache(maxsize = 128)
...
async def request(endpoint: str, headers: dict, params: dict) -> requests.Response:
...
async def data(slug: str, oauth_token: str, client_id: str) -> requests.Response:
...
async def helix(category: str, data: list, oauth_token: str, client_id: str) -> requests.Response:
...
async def top_clips(headers: dict, params: dict, oauth_token: str) -> requests.Response:
...
async def get(name: str, **args) -> dict:
