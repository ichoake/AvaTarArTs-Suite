...
class SmartRenamer:
    ...
    def scan_files(self):
        ...
        print(f"{Colors.GREEN}Checking {len(files_to_check)} files...{Colors.END}\n")
        
        for idx, filepath in enumerate(files_to_check, 1):
            if idx % 200 == 0:
                print(f"{Colors.YELLOW}Progress: {idx}/{len(files_to_check)}...{Colors.END}", end='\r')
    ...
    def generate_report(self):
        ...
        with open(report_file, 'w') as f:
            ...
            f.write("## 📝 EXAMPLES\n\n")
            by_ext = defaultdict(list)
            for item in self.rename_plan[:100]:
                by_ext[item['ext']].append(item)
    ...
    def run(self):
        ...
        print("╔═══════════════════════════════════════════════════════════════════════════════╗")
        print("║                                                                               ║")
        print("║              🏷️ SMART CONTENT-AWARE RENAMER V2 🧠                           ║")
        print("║                                                                               ║")
        print("║         Intelligent Naming with Style Consistency                            ║")
        print("║                                                                               ║")
        print("╚═══════════════════════════════════════════════════════════════════════════════╝")
        print(f"{Colors.END}\n")
