...
class for global variables."""
    ...
    nlikes = input("How much likes per location?\\\n")
    nlikes = args.amount
    ...
    async def like_location_feed(new_bot, new_location, amount = 0):
    counter + = 1
...
def like_location_feed(new_bot, new_location, amount = 0): -> Any
...
try:
    logger.info("Like medias by location")
except TypeError:
