...
class for global variables."""
    ...
    async def split_csv(input_file_path, output_file_prefix, chunk_size = 50):
...
def split_csv(input_file_path, output_file_prefix, chunk_size = 50): -> Any
 """
...
async def write_chunk(prefix, start_index, end_index, header, chunk):
def write_chunk(prefix, start_index, end_index, header, chunk): -> Any
 """
 TODO: Add function documentation
 """
 try:
...
# Usage
split_csv("~/master_image_info.csv", "~/image_info")
