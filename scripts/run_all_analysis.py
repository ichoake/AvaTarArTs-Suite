...
class MasterRunner:
    ...
    def run_all(self):
        ...
        print("║                                                                               ║")
        print("║            Running ALL Tools on Consolidated Python Directory                ║")
        print("║                                                                               ║")
        print("╚═══════════════════════════════════════════════════════════════════════════════╝")
        print(f"{Colors.END}\n")
        
        print(f"{Colors.CYAN}Target: {self.target}{Colors.END}")
        print(f"{Colors.CYAN}Scripts: {self.scripts}{Colors.END}\n")
        ...
        self.run_tool(
            ...
            'STEP 7: Generate renaming suggestions (100 files)'
        )
    ...
    def generate_master_report(self):
        ...
        print(f"{Colors.GREEN}✅ Master report: {report_file}{Colors.END}")
        ...
        print(f"  ⚠️  Warnings: {warning_count}/{len(self.results)}")
        print(f"  ❌ Failed: {failed_count}/{len(self.results)}\n")
        
        print(f"{Colors.BOLD}⏱️  Duration: {elapsed.total_seconds():.1f} seconds{Colors.END}\n")
        
        print(f"{Colors.GREEN}📊 All findings exported to CSV files!{Colors.END}")
        print(f"{Colors.GREEN}📚 Master report: {report_file.name}{Colors.END}\n")
...
def main():
    ...
    parser.add_argument('--scripts', type=str,
                       default="/Users/steven/GitHub/AvaTarArTs-Suite/scripts",
