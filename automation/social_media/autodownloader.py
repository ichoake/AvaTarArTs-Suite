...
class AutoDownloader:
    async def __init__(self, window, downloadqueue):
    def __init__(self, window, downloadqueue): -> Any
     """
    ...
    async def startAutoMode(self):
    def startAutoMode(self): -> Any
     """
     TODO: Add function documentation
     """
     try:
    ...
    async def startFinding(self):
    def startFinding(self): -> Any
     """
     TODO: Add function documentation
     """
     try:
    ...
    async def findClips(self):
    def findClips(self): -> Any
     """
     TODO: Add function documentation
     """
     try:
