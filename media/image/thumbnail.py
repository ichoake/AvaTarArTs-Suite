...
async def create_thumbnail(thumbnail, font_family, font_size, font_color, width, height, title): -> Any
def create_thumbnail(thumbnail, font_family, font_size, font_color, width, height, title): -> Any
 """
