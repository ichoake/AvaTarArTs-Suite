...
[Multiple image inputs](https://platform.openai.com/docs/guides/vision/multiple-image-inputs)
...
[FAQ](https://platform.openai.com/docs/guides/vision/faq)

[Can I fine-tune the image capabilities in `gpt-4`?](https://platform.openai.com/docs/guides/vision/can-i-fine-tune-the-image-capabilities-in-gpt-4)

No, we do not support fine-tuning the image capabilities of `gpt-4` at this time.

[Can I use `gpt-4` to generate images?](https://platform.openai.com/docs/guides/vision/can-i-use-gpt-4-to-generate-images)
